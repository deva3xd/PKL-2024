            ...
            <div class="text-center text-black">
                ...
                <form method="POST" action="{{ route('storeRegister') }}">
                    ...
                    <div class="mt-4 flex items-center gap-4 border p-4 rounded-xl" style="background-color: #F1F1F1">
                        ...
                        <input type="password" placeholder="Password" class="focus:outline-none w-full" style="background-color: #F1F1F1" name="password" required min="8" />
                    </div>
                    <div class="mt-4 flex items-center gap-4 border p-4 rounded-xl" style="background-color: #F1F1F1">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" class="w-4 h-4 opacity-70"><path fill-rule="evenodd" d="M14 6a4 4 0 0 1-4.899 3.899l-1.955 1.955a.5.5 0 0 1-.353.146H5v1.5a.5.5 0 0 1-.5.5h-2a.5.5 0 0 1-.5-.5v-2.293a.5.5 0 0 1 .146-.353l3.955-3.955A4 4 0 1 1 14 6Zm-4-2a.75.75 0 0 0 0 1.5.5.5 0 0 1 .5.5.75.75 0 0 0 1.5 0 2 2 0 0 0-2-2Z" clip-rule="evenodd" /></svg>
                        <input type="password" placeholder="Konfirmasi Password" class="focus:outline-none w-full" style="background-color: #F1F1F1" name="password_confirmation" required min="8" />
                    </div>
                    <button type="submit" class="btn border-none mt-8 p-4 rounded-xl text-white w-full bg-blue-700 hover:bg-blue-800 font-bold text-1xl">REGISTER</button>
                </form>
                <p>Sudah punya akun? <a href="{{ route('login') }}" class="text-blue-700">Masuk</a> Sekarang</p>
            </div>
        </div>
    </div>
@endsection